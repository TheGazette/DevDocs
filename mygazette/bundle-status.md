...
If the response to the above endpoint contains validation errors, a report with further details per notice can be retreived from the validation report endpoint. 
